...
DEFAULT_FROM_EMAIL  = os.getenv('DEFAULT_FROM_EMAIL', 'FarmBuddy <noreply@farmbuddy.com>')
EMAIL_TIMEOUT       = 10  # seconds; prevents SMTP hangs from consuming Render's 30s HTTP budget
# ─────────────────────────────────────────────────────────────────────────────
